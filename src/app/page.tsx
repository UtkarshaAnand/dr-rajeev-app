        ...
        <section className="grid md:grid-cols-2 gap-8 items-center py-10 md:py-16">
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a className="w-8 h-8 rounded-full bg-green-500 grid place-items-center text-white hover:bg-green-600 transition-colors" href="https://wa.me/9038234657" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              ...
              <a className="w-8 h-8 rounded-full bg-slate-800 grid place-items-center text-white hover:bg-slate-700 transition-colors" href="mailto:rajeev6670@gmail.com" aria-label="Email">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                </svg>
              </a>
              <a className="w-8 h-8 rounded-full bg-slate-800 grid place-items-center text-white hover:bg-slate-700 transition-colors" href="tel:9038234657" aria-label="Phone">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
